...
<html lang="en">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h3> Daftar Anggota Koperasi Dhana Niti</h3>
            </div>
            <div class="col-sm-2">
                <a class="btn btn-success" href="{{ route('mahasiswa.create')}}"> Tambah Anggota </a>
            </div>
        </div> 
        <br>
    ...
    <table class="table table-striped">
      <thead>
        <tr>
            ...
            <th width="100px">Kode Undangan</th>
            <th width="210px">No Registrasi</th>
